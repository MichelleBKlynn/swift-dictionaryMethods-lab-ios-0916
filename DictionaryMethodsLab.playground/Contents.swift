...
if starWarsCharacters.isEmpty {
    ...
    print("There are \(starWarsCharacters.count) items in the directory.")
}
...
if let characterz = starWarsCharacters["Jedi"] {
...
starWarsCharacters["Bounty Hunters"] = nil

if let bountyHunersOrNaw = starWarsCharacters["Bounty Hunters"] {
